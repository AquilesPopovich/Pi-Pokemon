            ...
            <section className={style.formContainer}>
                <article className={style.formArticle}>
                    ...
                    <label className={style.formLabel}>Name:</label>
                        ...
                        <input type="text" value={inputData.sprite} className={style.formInput}   name='sprite' id='sprite' onChange={handleChange} />
                        {errors.sprite !== null && <p>{errors.sprite}</p>}


                        <label className={style.formLabel}> Hp:</label>
                        <input type="text" value={inputData.hp} className={style.formInput}  name='hp' id='hp' onChange={handleChange} />
                        {errors.hp !== null && <p>{errors.hp}</p>}

                        <label className={style.formLabel} >Attack:</label>
                        <input type="text" value={inputData.atk} name='atk' className={style.formInput}  onChange={handleChange} />
                        {errors.atk !== null  && <p>{errors.attack}</p>}

                        <label className={style.formLabel} >Special Attack:</label>
                        <input type="text" value={inputData.spAtk} className={style.formInput}  name='spAtk' onChange={handleChange} />
                        {errors.spAtk && <p>{errors.spAtk}</p>}

                        <label className={style.formLabel}>Defense:</label>
                        <input type="text" value={inputData.def} className={style.formInput}  name='def' onChange={handleChange} />
                        {errors.def !== null && <p>{errors.def}</p>}

                        <label  className={style.formLabel}>Special Defense:</label>
                        <input type="text" value={inputData.spDef} className={style.formInput}  name='spDef' onChange={handleChange} />
                        {errors.spDef !== null && <p>{errors.spDef}</p>}

                        <label  className={style.formLabel}>Speed:</label>
                        <input type="text" value={inputData.spd} className={style.formInput}  name='spd' onChange={handleChange} />
                        {errors.spd !== null && <p>{errors.speed}</p>}

                        <label className={style.formLabel}>Height:</label>
                        <input type="text" value={inputData.height} className={style.formInput}  name='height' onChange={handleChange} />
                        {errors.height !== null && <p>{errors.height}</p>}

                        <label className={style.formLabel}>Weight:</label>
                        <input type="text" value={inputData.weight} className={style.formInput}  name='weight' onChange={handleChange} />
